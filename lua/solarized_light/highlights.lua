local highlights = {
		...
		QuickFixLine = {fg = C.bg, bg = C.ui3_blue, },
		...
		IncSearch = {fg = C.light_blue, bg = C.fg_light, },
		CurSearch = {fg = C.fg_light, bg = C.purple, },
		Substitute = {fg = C.fg_light, bg = C.purple, },
		MoreMsg = {fg = C.orange, },
